...
describe('contentDisposition(filename, options)', function () {
    describe('with "fallback" option', function () {
        it('should require a string or Boolean', function () {
            assert.throws(
                contentDisposition.bind(null, 'plans.pdf', { fallback: 42 }),
                /fallback.*string/,
            );
        });
    ...
    describe('with "type" option', function () {
        ...
        it('should require a string', function () {
            assert.throws(
                contentDisposition.bind(null, undefined, { type: 42 }),
                /invalid type/,
            );
        });
        ...
        it('should require a valid type', function () {
            assert.throws(
                contentDisposition.bind(null, undefined, {
                    type: 'invlaid;type',
                }),
                /invalid type/,
            );
    ...
    describe('from TC 2231', function () {
        describe('Disposition-Type Inline', function () {
            ...
            it('should parse "inline; filename="foo.html""', function () {
                assert.ok(
                    deepEqual(
                        contentDisposition.parse('inline; filename="foo.html"'),
                        {
                            type: 'inline',
            ...
            it('should parse "inline; filename="foo.pdf""', function () {
                assert.ok(
                    deepEqual(
                        contentDisposition.parse('inline; filename="foo.pdf"'),
                        {
                            type: 'inline',
