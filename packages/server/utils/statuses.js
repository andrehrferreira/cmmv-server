...
status.code = exports.statuses.code;
status.codes = exports.statuses.codes;
status.redirect = exports.statuses.redirect;
status.empty = exports.statuses.empty;
status.retry = exports.statuses.retry;
/**
 * Get the status code.
 *
...
function status(code) {
    if (typeof code === 'number')
        return exports.statuses.getStatusMessage(code);
    if (typeof code !== 'string')
        throw new TypeError('code must be a number or string');
    // '403'
    const n = parseInt(code, 10);
    if (!isNaN(n))
        return exports.statuses.getStatusMessage(n);
    return exports.statuses.getStatusCode(code);
}
