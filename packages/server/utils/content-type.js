...
exports.setCharset = exports.contentTypeParse = exports.contentTypeFormat = void 0;
/**
...
exports.contentTypeFormat = contentTypeFormat;
/**
...
exports.contentTypeParse = contentTypeParse;
exports.default = { format: exports.contentTypeFormat, parse: exports.contentTypeParse };
/**
...
const setCharset = (type, charset) => {
    if (!type || !charset)
        return type;
    const parsed = (0, exports.contentTypeParse)(type);
    parsed.parameters.charset = charset;
    return (0, exports.contentTypeFormat)(parsed);
};
