...
exports.compileETag = exports.wetag = exports.etag = void 0;
exports.createETagGenerator = createETagGenerator;
/*!
 * etag
 ...
 * @public
 */
function etagGen(entity, options) {
    if (entity == null)
