/**
 * @see https://github.com/expressjs/express/blob/master/test/Router.js
 */
...
describe('Router', function () {
    ...
    /*it('should not stack overflow with a large sync route stack', function (done) {
        this.timeout(10000) // long-running test
    
        var router = new Router()
    
        router.get('/foo', function (req: any, res, next) {
            req.counter = 0
            next()
        })
        ...
        router.get('/foo', function (req: any, res) {
    ...
    describe('.param', function () {
        ...
        /*it('should only call once per request', function(done) {
            var count = 0;
            var req = { url: '/foo/bob/bar', method: 'get', user: "" };
            var router = new Router();
            var sub = new Router();
    ...
    /*describe('parallel requests', function() {
        it('should not mix requests', function(done) {
            var req1 = { url: '/foo/50/bar', method: 'get', ms: 0, originalUrl: "" };
            var req2 = { url: '/foo/10/bar', method: 'get', ms: 0, originalUrl: "" };
            var router = new Router();
            var sub = new Router();
            var cb = after(2, done)
