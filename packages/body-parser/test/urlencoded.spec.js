        ...
        describe('when true', function () {
            ...
            it('should parse array index notation with large array', function (done) {
                ...
                request(this.server)
                    ...
                    assert_1.strict.strictEqual(Object.keys(obj).length, 1);
                    assert_1.strict.strictEqual(Array.isArray(obj.f), true);
                    assert_1.strict.strictEqual(obj.f.length, 500);
                })
                    .expect(200, done);
            });
            ...
            it('should parse deep object', function (done) {
                ...
                request(this.server)
                    ...
                    const obj = JSON.parse(res.text);
                    assert_1.strict.strictEqual(Object.keys(obj).length, 1);
                    assert_1.strict.strictEqual(typeof obj.foo, 'object');
                    let depth = 0;
                    let ref = obj.foo;
                    while ((ref = ref.p)) {
                        depth++;
                    }
                    assert_1.strict.strictEqual(depth, 32);
                })
                    .expect(200, done);
            });
        });
...
function createServer(opts) {
    const _bodyParser = typeof opts !== 'function' ? bodyParser.urlencodedExpress(opts) : opts;
...
function expectKeyCount(count) {
    return function (res) {
        assert_1.strict.strictEqual(Object.keys(JSON.parse(res.text)).length, count);
    };
}
