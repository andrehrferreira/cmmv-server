...
describe('bodyParser.json()', function () {
    ...
    describe('charset', function () {
        ...
        it('should parse utf-32', function (done) {
            ...
            test.write(
                Buffer.from(
                    'fffe00007b000000220000006e000000610000006d00000065000000220000003a00000022000000ba8b0000220000007d000000',
                    'hex',
                ),
            );
            test.expect(200, '{"name":"论"}', done);
    ...
    describe('encoding', function () {
        ...
        brotlit('should support brotli encoding', function (done) {
            ...
            test.set('Content-Type', 'application/json');
            test.write(
                Buffer.from('8b06807b226e616d65223a22e8aeba227d03', 'hex'),
            );
            test.expect(200, '{"name":"论"}', done);
        });
