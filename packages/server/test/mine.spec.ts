...
describe('class Mime', function () {
    it('new constructor()', () => {
        ...
        assert.equal(mime.getType('a'), 'text/a');
        assert.equal(mime.getType('a1'), 'text/a');
        assert.equal(mime.getType('b'), 'text/b');
        assert.equal(mime.getType('b1'), 'text/b');

        assert.equal(mime.getExtension('text/a'), 'a');
        assert.equal(mime.getExtension('text/b'), 'b');
    });
});
