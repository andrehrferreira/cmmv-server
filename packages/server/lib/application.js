...
class Application extends node_events_1.EventEmitter {
    ...
    async _handler(req, res) {
        this.route(req.method, req.url)
            ...
            request.preParsing = this[symbols_1.kHooks].preParsing;
            request.preHandler = this[symbols_1.kHooks].preHandler;
            response.onSend = this[symbols_1.kHooks].onSend;
            response.onError = this[symbols_1.kHooks].onError;
            ...
            if (this[symbols_1.kHooks].onRequest &&
                this[symbols_1.kHooks].onRequest.length > 0) {
                (0, hooks_1.onRequestHookRunner)(this[symbols_1.kHooks].onRequest, request, response, this.runPreParsing);
            }
            else {
                this.runPreParsing(null, request, response);
            }
            if (this[symbols_1.kHooks].onRequestAbort !== null &&
                this[symbols_1.kHooks].onRequestAbort.length > 0) {
                req.on('close', () => {
                    /* istanbul ignore else */
                    if (req.aborted) {
                        (0, hooks_1.onRequestAbortHookRunner)(this[symbols_1.kHooks].onRequestAbort, request, this.handleOnRequestAbortHooksErrors.bind(null, response));
                    }
                });
            }
        })
